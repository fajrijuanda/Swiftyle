...
<header class="main-nav">
    <div class="sidebar-user text-center">
        <a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="{{ session::get('avatar')}}" alt="" />
        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li>
                        <a class="nav-link menu-title link-nav {{ routeActive('data-user') }}" href="{{ route('data-user') }}"><i data-feather="database"></i><span>Data User</span></a>
                    </li>
                    <li>
                        <a class="nav-link menu-title link-nav {{ routeActive('jsgrid-table') }}" href="{{ route('jsgrid-table') }}"><i data-feather="database"></i><span>Data Order</span></a>
                    </li>
                    <li>
                        <a class="nav-link menu-title link-nav {{ routeActive('jsgrid-table') }}" href="{{ route('jsgrid-table') }}"><i data-feather="database"></i><span>Complain User</span></a>
                    </li>
                    ...
                    <li>
                        <a class="nav-link menu-title link-nav {{ routeActive('jsgrid-table') }}" href="{{ route('jsgrid-table') }}"><i data-feather="database"></i><span>Add Shop</span></a>
                    </li>
                    <li>
                        <a class="nav-link menu-title link-nav {{ routeActive('jsgrid-table') }}" href="{{ route('jsgrid-table') }}"><i data-feather="database"></i><span>Data Order</span></a>
                    </li>
                    ...
                    <li>
                        <a class="nav-link menu-title link-nav {{ routeActive('jsgrid-table') }}" href="{{ route('jsgrid-table') }}"><i data-feather="grid"></i><span>Category</span></a>
                    </li>
                    <li>
                        <a class="nav-link menu-title link-nav {{ routeActive('jsgrid-table') }}" href="{{ route('jsgrid-table') }}"><i data-feather="grid"></i><span>Product</span></a>
                    </li>
                    <li>
                        <a class="nav-link menu-title link-nav {{ routeActive('jsgrid-table') }}" href="{{ route('jsgrid-table') }}"><i data-feather="grid"></i><span>Genre</span></a>
                    </li>
                    <li>
                        <a class="nav-link menu-title link-nav {{ routeActive('jsgrid-table') }}" href="{{ route('jsgrid-table') }}"><i data-feather="grid"></i><span>Style</span></a>
                    </li>
                    ...
                    <li>
                        <a class="nav-link menu-title link-nav {{ routeActive('jsgrid-table') }}" href="{{ route('jsgrid-table') }}"><i data-feather="database"></i><span>Data User</span></a>
                    </li>

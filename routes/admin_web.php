...
Route::view('data-user', 'admin.users.data-user')->name('data-user');
Route::view('user-profile', 'admin.users.user-profile')->name('user-profile');
Route::view('user-edit', 'admin.users.user-edit')->name('user-edit');

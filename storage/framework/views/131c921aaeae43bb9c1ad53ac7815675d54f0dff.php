...
<header class="main-nav">
    <div class="sidebar-user text-center">
        <a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="<?php echo e(session::get('image')); ?>" alt="" />
...
<?php /**PATH C:\laragon\www\Swiftyle-main\resources\views/layouts/admin/partials/sidebar.blade.php ENDPATH**/ ?>
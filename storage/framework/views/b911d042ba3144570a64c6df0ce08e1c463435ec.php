<div class="page-main-header">
  <div class="main-header-right row m-0">
    <div class="main-header-left">
      <div class="logo-wrapper"><a href="<?php echo e(route('index')); ?>"><img class="img-fluid" src="<?php echo e(asset('assets/images/logo/logo.png')); ?>" alt="" style="width: 100px; height: auto;"></a></div>
      <div class="dark-logo-wrapper"><a href="<?php echo e(route('index')); ?>"><img class="img-fluid" src="<?php echo e(asset('assets/images/logo/dark-logo.png')); ?>" alt="" style="width: 100px; height: auto;"></a></div>
    ...
    <div class="nav-right col pull-right right-menu p-0">
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown p-0">
          ...
          <button class="btn btn-primary-light" type="button"><a class="link" href="<?php echo e(route('login')); ?>"><i data-feather="log-out"></i>Log out</a></button>
        </li>
      </ul>
    </div>
    <div class="d-lg-none mobile-toggle pull-right w-auto"><i data-feather="more-horizontal"></i></div>
  </div>
</div><?php /**PATH C:\laragon\www\Final Project Kelompok 7\resources\views/layouts/admin/partials/header.blade.php ENDPATH**/ ?>